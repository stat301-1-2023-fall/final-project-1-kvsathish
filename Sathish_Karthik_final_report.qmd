...
Analysis - evaluate score to negative statistic to see if it correlates with negative performance - similar centers of distribution and most IQRs lying from 2.5-3.5 indicates that higher scores indicate greater turnovers or negative performance
